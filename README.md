...
│   ├── controller/               # REST API (Auth, Agent, LogEvent)
│   ├── service/                  # 业务逻辑 (AgentService, LogEventService)
│   ├── entity/                   # JPA 实体 (Agent, AgentConfig, LogEventEntity, Alert, SysUser)
│   ├── repository/               # 数据访问层
