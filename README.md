...
│   ├── controller/               # REST API (Auth, Agent, LogEvent, FimEvent, Alert, Rule)
│   ├── service/                  # 业务逻辑 (AgentService, LogEventService, FimEventService, AlertService)
│   ├── entity/                   # JPA 实体 (Agent, AgentConfig, LogEventEntity, FimEventEntity, Alert, SysUser)
│   ├── repository/               # 数据访问层
